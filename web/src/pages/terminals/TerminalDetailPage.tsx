 ...
 * for, what can I do about it, and -- behind "Advanced" -- what is it running
 * and how does it reach us.
 *
 * SIMPLE BY DEFAULT, COMPLETE ON REQUEST. The everyday answer (health, status,
 * the outage policy, disable/re-enable, test access) is on the first screen;
 * the destructive and the technical are one press away under "More actions"
 * and "Advanced". Nothing was removed and no gate, handler or dialog changed:
 * what changed is what a person who only wants "is this terminal working"
 * has to scroll past to find out.
 *
 * THE ACTIONS UNDER "MORE ACTIONS" ARE THE ONES THAT MATTER MOST AND ARE THE
 * HARDEST TO GET RIGHT. Disable, revoke and retire sound interchangeable and
 * are not, and an operator reaching for one of them is usually in a hurry and
 * often standing in front of the hardware. So they are presented as separate,
 * differently weighted actions with the consequence stated on each — never as
 * one control with a mode — and each names the situation it is for rather than
 * only what it does. See TerminalLifecycleDialogs.
 */
    ...
    <div className="page">
      ...
      */}
      ...
      <section className="cards" aria-label="Status">
        ...
        */}
        ...
        {/*
          ...
          "SWITCHED ON" RATHER THAN "IN SERVICE -- YES". The fact is the same
          boolean; the words are the ones a person uses about a thing staff can
          switch off from this page, which is what the Disable action below is.
        */}
        <article className="card">
          <h2 className="card__title">Switched on</h2>
          <p className="card__value">
          ...
          <p className="card__detail">
            {terminal.active
              ...
              : 'switched off by staff — it lets nobody in'}
          </p>
        </article>
        ...
        {/*
          ...
          IT STAYS ON THE FIRST SCREEN when the technical cards moved into
          Advanced: it is the one card here that says whether people get in.
        */}
        <article className="card">
      ...
      <section className="panel" aria-labelledby="terminal-application-heading">
        <div className="panel__header">
          ...
          <p className="field__hint">
            The feature this terminal is assigned to. Which features your company has
            at all is set under Features.
          </p>
        </div>
      ...
      {/*
        ...
        TWO ACTIONS ON THE FIRST SCREEN, FIVE BEHIND "MORE ACTIONS". Disable,
        revoke, retire, release, move, resync and check-access used to sit in
        two lists of equal weight, so somebody who only wanted "is this
        terminal working" scrolled past "Revoke credential" to find out. The
        two here are the everyday ones: switching a terminal off and back on,
        and testing what it would decide for a person. Everything else is still
        on this page, one press away, with every gate, handler and dialog it
        always had -- what changed is what a reader meets first.

        THE DISTINCTION INSIDE "MORE ACTIONS" IS THE ONE THAT MATTERS MOST AND
        IS THE HARDEST TO GET RIGHT. Disable, revoke and retire sound
        interchangeable and are not, and an operator reaching for one of them
        is usually in a hurry and often standing in front of the hardware. So
        they stay three separate, differently weighted actions with the
        consequence stated on each — never one control with a mode — and each
        names the situation it is for rather than only what it does. See
        TerminalLifecycleDialogs.
      */}
      <section className="panel" aria-labelledby="terminal-actions-heading">
        <div className="panel__header">
          <h2 className="panel__title" id="terminal-actions-heading">
            Actions
          </h2>
        </div>

        {!mayAdminister || !mayConfigure ? (
          <InfoNote title="Read only">
            {!mayAdminister ? 'Switching a terminal off and on is an administrator action. ' : null}
            {!mayConfigure
              ? 'Testing access needs a manager or above. '
              : null}
        ...
        <ul className="lifecycle">
          <li className="lifecycle__option">
            <div className="lifecycle__text">
              ...
              <p className="lifecycle__detail">
                {terminal.active
                  ? 'Switches it off: it lets nobody in until it is re-enabled. Reversible from this page with no site visit — for a faulty unit, or an entrance that is closed for now.'
                  : 'This terminal is switched off. Re-enabling brings it back exactly as it was.'}
              </p>
            </div>
            <button
              type="button"
          ...
          <li className="lifecycle__option">
            <div className="lifecycle__text">
              <h3 className="lifecycle__title">Test access for a person</h3>
              <p className="lifecycle__detail">
                See whether one person would be let in at this terminal right now,
                and why. Records nothing and changes nothing — the thing to do after
                changing a rule, instead of sending somebody to stand at it.
              </p>
            </div>
        ...
        <details className="disclosure">
          <summary className="disclosure__summary" id="terminal-more-actions-title">
            More actions
          </summary>
          ...
          <div className="disclosure__body disclosure__body--stretch">
            ...
            {!mayAdminister ? (
              <InfoNote title="Read only">
                Blocking, retiring, handing over and moving a terminal are administrator actions.
                {mayConfigure
                  ? ' You can still change what this terminal is for, test access, and resend its people and settings from this page.'
                  : ' Ask an administrator or owner of your company if one of these is needed.'}
              </InfoNote>
            ) : null}
            ...
            <ul className="lifecycle">
              <li className="lifecycle__option">
                <div className="lifecycle__text">
                  <h3 className="lifecycle__title">Block this terminal</h3>
                  <p className="lifecycle__detail">
                    For hardware that is <strong>missing, stolen or out of your
                    control</strong>. Revoking its credential stops it working until
                    it is set up again — issue a claim code for its serial from{' '}
                    <Link to={`/sites/${terminal.site_public_id}`}>{terminal.site_name}</Link>{' '}
              ...
              <li className="lifecycle__option">
                <div className="lifecycle__text">
                  ...
                  <p className="lifecycle__detail">
                    Removes it from your account for good. For a unit that has been
                    decommissioned, destroyed or returned. Cannot be undone.
                  </p>
                </div>
                <button
                  type="button"
              ...
              <li className="lifecycle__option">
                <div className="lifecycle__text">
                  <h3 className="lifecycle__title">Hand over to another account</h3>
                  <p className="lifecycle__detail">
                    Releases the unit for <strong>another AccessLink account</strong>. It
                    stops working, erases every person and every enrolled finger it holds,
              ...
              <li className="lifecycle__option">
                <div className="lifecycle__text">
                  ...
                  <p className="lifecycle__detail">
                    Changes which people this terminal knows about. It erases what it
              ...
              <li className="lifecycle__option">
                <div className="lifecycle__text">
                  <h3 className="lifecycle__title">Resend everything to this terminal</h3>
                  <p className="lifecycle__detail">
                    Sends it a fresh copy of the people and settings it should hold, in
                    place of anything still queued. Nothing is destroyed and it keeps
                    working throughout.
                  </p>
                </div>
            ...
            {/*
              ...
              happens "using its site's provisioning key", which was true and is
              now the path to avoid: that key registers every terminal at the
              site, for ever, and putting it on an installer's laptop is what
              claim codes were built to stop. The console CAN take part now — it
              issues the code.
            */}
            <p className="field__hint">
      ...
      {/*
        ...
        THE SOFTWARE AND THE NETWORK, BEHIND ONE DISCLOSURE. Both sections are
        exactly what they were -- the rows, the notes, the Change Wi-Fi action
        and its gate -- and both answer questions somebody asks after "is it
        working" has been answered above: what version is it on, how does it
        reach us. Folded, they stop competing with the answer; opened, nothing
        is missing. "Technical details" stays nested inside, as it was.
      */}
      <section className="panel" aria-labelledby="terminal-advanced-title">
        <details className="disclosure">
          <summary className="disclosure__summary" id="terminal-advanced-title">
            Advanced
          </summary>

          <div className="disclosure__body disclosure__body--stretch">
            {/* --- what it is running --------------------------------------- */}
            <section className="panel panel--nested" aria-labelledby="terminal-firmware-heading">
              <div className="panel__header">
                <h3 className="panel__title" id="terminal-firmware-heading">
                  Software version
                </h3>
              </div>
              ...
              <dl className="detail-list">
                ...
                */}
                ...
                <div className="detail-list__row">
                  <dt>Current version for its channel</dt>
                  <dd>
                    <code className="mono">{terminal.current_firmware_version || '—'}</code>
                  </dd>
                </div>
                {/*
                  LAST SYNC LIVES HERE NOW rather than as a fifth status card. It
                  is a real fact -- when the terminal last collected its people and
                  settings -- but "last check-in" already answers "is it in
                  contact", and this is the follow-up somebody asks when a change
                  has not reached a unit, which is what this section is for.
                */}
                <div className="detail-list__row">
                  <dt>Last sync</dt>
                  <dd>
                    {terminal.last_sync_at ? (
                      <>
                        ...
                        <span className="muted">
                          — when it last collected the people and settings it holds
                        </span>
                      </>
                    ) : (
                      <span className="muted">Never</span>
            ...
            {/*
              ...
              A SECTION OF ITS OWN rather than a sixth entry in More actions, and
              the split is the point. Everything there answers "should this
              terminal be in service"; this answers "how does it get to us",
              which is the question somebody has when the answer to the first
              one is yes and the access point still does not work.

              It also has a different audience. Disable, revoke and retire are
              things an administrator decides. Changing the Wi-Fi is something
              that HAPPENS TO a customer — the router was replaced, the password
              rotated — and they arrive here looking for the word "Wi-Fi" rather
              than for a lifecycle operation.
            */}
            <section className="panel panel--nested" aria-labelledby="terminal-network-heading">
              <div className="panel__header">
                <h3 className="panel__title" id="terminal-network-heading">
                  Network
                </h3>
                <p className="field__hint">
              ...
              */}
              ...
              <ul className="lifecycle">
                <li className="lifecycle__option">
                  <div className="lifecycle__text">
                    <h4 className="lifecycle__title">Change Wi-Fi</h4>
                    <p className="lifecycle__detail">
