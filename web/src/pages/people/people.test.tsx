...
describe('biometric non-disclosure', () => {
  ...
  it('says enrolment is not available from the console rather than faking it', async () => {
    ...
    // In the operator's terms: where it happens, and that this screen cannot do
    // it. What it must NOT do is describe our API surface -- see below.
    expect(
      screen.getByText(/enrolled by going to a terminal in person/i),
    ).toBeInTheDocument()
